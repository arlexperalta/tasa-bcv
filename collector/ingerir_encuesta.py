...
def resumen():
    ...
    if resp < MIN_VEREDICTO and vistas < MIN_IMPRESIONES_POBLACION:
        ...
        print()
        print("QUÉ ES EXACTAMENTE, en tres partes, y las tres hacen falta:")
        print()
        print("  1. Son DISPOSITIVOS, no personas. Quien usa tasa en el teléfono y en")
        print("     la computadora cuenta dos veces.")
        print("  2. Es un PISO, no un total. No aparece quien borró los datos del")
        print("     navegador ni quien la tuvo abierta en segundo plano sin tocarla.")
        print("  3. Es gente que volvió Y ADEMÁS USÓ LA CALCULADORA HASTA EL FINAL:")
        print("     monto en los dos campos y tres segundos quieta mirando el")
        print("     resultado. Esa es la condición que dispara la pieza.")
        print()
        print("La tercera es la que hace que el número signifique algo, y por eso NO")
        print("es comparable con las sesiones de Umami. Quien las cruce va a concluir")
        print("que la pieza pierde gente: no pierde nada, descarta al que solo le echó")
        print("un ojo al número del día y se fue. Esto no son visitantes recurrentes,")
        print("son USUARIOS recurrentes — más estrecho, más difícil y vale más.")
        print()
